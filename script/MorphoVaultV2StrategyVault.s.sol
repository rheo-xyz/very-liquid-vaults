...
contract MorphoVaultV2StrategyVaultScript is BaseScript {
    ...
    function run() public {
        ...
        console.log("MorphoVaultV2StrategyVault", address(deploy(auth, firstDepositAmount, vault)));
    ...
    function deploy(Auth auth_, uint256 firstDepositAmount_, IERC4626 vault_)
        public
        returns (MorphoVaultV2StrategyVault morphoVaultV2StrategyVault)
    {
        ...
        address implementation = address(new MorphoVaultV2StrategyVault());
        ...
        morphoVaultV2StrategyVault =
            MorphoVaultV2StrategyVault(create2Deployer.computeAddress(salt, keccak256(creationCode)));
        IERC20Metadata(address(vault_.asset())).forceApprove(address(morphoVaultV2StrategyVault), firstDepositAmount_);
